...
public class SourceModel {
    ...
    public SourceModel(String id, String name, String description, String url, String language, String country, UrlsToLogos urlsToLogos, ArrayList<String> sortBysAvailable) {
        this.id = id;
        this.name = name;
